...
function ServiceVisual({ type }) {
  if (type === "grid") {
    return (
      <div className="grid h-20 w-20 sm:h-24 sm:w-24 grid-cols-3 gap-1.5 sm:gap-2" data-motion-visual>
  ...
  if (type === "mark") {
    return (
      <div className="relative h-20 w-20 sm:h-24 sm:w-24" data-motion-visual>
  ...
  if (type === "stack") {
    return (
      <div className="relative h-20 w-24 sm:h-24 sm:w-28" data-motion-visual>
  ...
  return (
    <div className="relative h-20 w-20 sm:h-24 sm:w-24 rounded-full border border-white/10 bg-white/[0.035]" data-motion-visual>
...
export default function Services() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-40" data-motion-section="services" id="servicios">
        ...
        <div className="grid gap-6 lg:grid-cols-2" data-motion-group>
          {services.map((service, index) => (
            <Card
              ...
              className="min-h-[20rem] sm:min-h-[26rem] p-0 lg:[&:nth-child(2)]:mt-14 lg:[&:nth-child(3)]:-mt-6"
              key={service.title}
            >
              <div className="relative flex h-full flex-col overflow-hidden rounded-[2rem] p-5 sm:p-9">
                ...
                <div className="relative mt-8 sm:mt-12 grid flex-1 gap-6 sm:gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-end">
                  <div>
                    <h3 className="text-3xl sm:text-4xl font-semibold leading-[0.96] tracking-[-0.06em] text-white sm:text-5xl" data-motion-title>
                      {service.title}
                    </h3>
